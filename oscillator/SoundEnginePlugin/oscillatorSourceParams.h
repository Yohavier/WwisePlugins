...
#ifndef oscillatorSourceParams_H
#define oscillatorSourceParams_H
...
struct oscillatorRTPCParams
{
    AkReal32 fDuration;
};

struct oscillatorNonRTPCParams
{
};

struct oscillatorSourceParams
    : public AK::IAkPluginParam
{
    oscillatorSourceParams();
    oscillatorSourceParams(const oscillatorSourceParams& in_rParams);
    ...
    oscillatorRTPCParams RTPC;
    oscillatorNonRTPCParams NonRTPC;
};

#endif // oscillatorSourceParams_H
