...
class SimpleConvolutionPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    SimpleConvolutionPlugin();
    ~SimpleConvolutionPlugin();
...
DECLARE_AUDIOPLUGIN_CONTAINER(SimpleConvolution);	// Exposes our PluginContainer structure that contains the info for our plugin
