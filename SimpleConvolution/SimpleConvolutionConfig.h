...
#ifndef SimpleConvolutionConfig_H
#define SimpleConvolutionConfig_H
...
namespace SimpleConvolutionConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 16544;
}

#endif // SimpleConvolutionConfig_H
