...
local Plugin = {}
Plugin.name = "SimpleConvolution"
Plugin.factoryheader = "../SoundEnginePlugin/SimpleConvolutionFXFactory.h"
Plugin.sdk = {}
Plugin.sdk.static = {}
Plugin.sdk.shared = {}
Plugin.authoring = {}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "SimpleConvolution.def",
    "SimpleConvolution.xml",
    "*.rc",
}
