...
#ifndef SimpleConvolutionFX_H
#define SimpleConvolutionFX_H
...
private:
    SimpleConvolutionFXParams* m_pParams;
    AK::IAkPluginMemAlloc* m_pAllocator;
    AK::IAkEffectPluginContext* m_pContext;

    std::vector<SimpleConvolution> myConv;
};

#endif // SimpleConvolutionFX_H
