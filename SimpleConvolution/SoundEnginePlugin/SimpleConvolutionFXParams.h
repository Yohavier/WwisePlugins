...
#ifndef SimpleConvolutionFXParams_H
#define SimpleConvolutionFXParams_H
...
struct SimpleConvolutionRTPCParams
{
    AkReal32 fPlaceholder;
};

struct SimpleConvolutionNonRTPCParams
{
};

struct SimpleConvolutionFXParams
    : public AK::IAkPluginParam
{
    SimpleConvolutionFXParams();
    SimpleConvolutionFXParams(const SimpleConvolutionFXParams& in_rParams);
    ...
    SimpleConvolutionRTPCParams RTPC;
    SimpleConvolutionNonRTPCParams NonRTPC;
};

#endif // SimpleConvolutionFXParams_H
