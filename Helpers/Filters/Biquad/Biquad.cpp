#include "Biquad.h"
#include <iostream>
void Biquad::ComputeCoeff(const AkReal32 frequency, const AkReal32 qualityFactor, const AkReal32 peakGain, const AkReal32 bTypeParam)
{
	...
	type = static_cast<BiquadType>(bTypeParam);
