...
#ifndef WTOscillatorConfig_H
#define WTOscillatorConfig_H
...
namespace WTOscillatorConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 20664;
}

#endif // WTOscillatorConfig_H
